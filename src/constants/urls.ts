...
// Lambda Function URL - non-streaming inference (IAM auth required, use ALB instead)
export const AIBUDDY_LAMBDA_URL = 'https://x6s3kwugl426vmsnv4evh6p2se0kbmke.lambda-url.us-east-2.on.aws'
// KAN-33 v2: Streaming Lambda Function URL — RESPONSE_STREAM mode, bypasses ALB buffering
// This URL is generated by `sls deploy` and must be updated after deployment
export const AIBUDDY_API_STREAM_URL = 'https://x6s3kwugl426vmsnv4evh6p2se0kbmke.lambda-url.us-east-2.on.aws'
